...
import com.handsome.module_engine.E.XRecyclerView.View.RefreshAndLoadMoreRecyclerView;
import com.handsome.module_engine.R;
...
public class DefaultRefreshView extends RefreshViewCreator {
    ...
    public View getRefreshView(Context context, ViewGroup parent) {
        View refreshView = LayoutInflater.from(context).inflate(R.layout.view_refresh, parent, false);
