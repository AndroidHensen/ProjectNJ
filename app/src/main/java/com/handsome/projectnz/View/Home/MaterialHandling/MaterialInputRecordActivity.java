...
public class MaterialInputRecordActivity extends BaseActivity{
    ...
    public void initData() {
        ...
        lv_record.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i=new Intent(MaterialInputRecordActivity.this,MaterialInputRecordDetailActivity.class);
