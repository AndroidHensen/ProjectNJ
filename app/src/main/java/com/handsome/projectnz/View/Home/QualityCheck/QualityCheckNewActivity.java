...
public class QualityCheckNewActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.activity_quality_check_new;
    }
    ...
    private void showDatePickerDialog() {
        ...
        new DatePickerDialog(QualityCheckNewActivity.this, new DatePickerDialog.OnDateSetListener() {
