...
public class DailyCheckCharacterActivity extends BaseActivity {
    private static final String TAG = "DailyCheckCharacterActi";
    ...
    public int getLayoutId() {
        return R.layout.activity_daily_check_character;
    }
