 ...
 * 本界面对应 主界面-项目模块-新建
 */
public class ProjectNewActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initFragments() {
        list = new ArrayList<>();
        list.add(new ProjectNewSummaryFragment());
        list.add(new ProjectNewDataFragment());
        list.add(new ProjectNewBuilderFragment());
