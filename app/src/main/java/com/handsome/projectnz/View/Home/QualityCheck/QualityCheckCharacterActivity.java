...
public class QualityCheckCharacterActivity extends BaseActivity {
    private static final String TAG = "QualityCheckCharacterAc";
    ...
    public int getLayoutId() {
        return R.layout.activity_quality_check_character;
    }
    ...
    public void processClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_inspect_team:
                ...
                break;
            case R.id.tv_edit2:
                Intent intent = new Intent(QualityCheckCharacterActivity.this, QualityCheckNewActivity.class);
