...
import com.handsome.projectnz.Fragment.Project.ProjectDetailBuilderFragment;
import com.handsome.projectnz.Fragment.Project.ProjectDetailFileFragment;
import com.handsome.projectnz.Fragment.Project.ProjectDetailSummaryFragment;
import com.handsome.projectnz.Fragment.Project.ProjectNewBuilderFragment;
import com.handsome.projectnz.Fragment.Project.ProjectNewDataFragment;
import com.handsome.projectnz.Fragment.Project.ProjectSumConductingFragment;
import com.handsome.projectnz.Fragment.Project.ProjectNewSummaryFragment;
...
public class ProjectDetailActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initFragments() {
        list = new ArrayList<>();
        list.add(new ProjectDetailSummaryFragment());
        list.add(new ProjectDetailFileFragment());
        list.add(new ProjectDetailBuilderFragment());
