...
public class WorkTaskOfficialReturnActivity extends BaseActivity {
    ...
    private ListView rv_progress_detail;//项目具体进度情况（反馈任务）
    ...
    private ReturnOfficialTaskAdapter adapter;
...
//        lists.add(dailyCheck1);
        adapter=new ReturnOfficialTaskAdapter(WorkTaskOfficialReturnActivity.this,lists);
        rv_progress_detail.setAdapter(adapter);
    }
