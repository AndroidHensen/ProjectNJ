...
public class WorkTaskProjectActivity extends BaseActivity {
    ...
    private Button bt_work_project_quit;//项目任务取消
    private Button bt_work_project_urge;//项目任务催促
    private Button bt_work_task_return;//项目任务反馈

    @Override
    public int getLayoutId() {
        return R.layout.activity_work_task_project;
    }
    ...
    public void initViews() {
        ...
        bt_work_project_quit = findView(R.id.bt_work_project_quit);
        bt_work_project_urge = findView(R.id.bt_work_project_urge);
        bt_work_task_return = findView(R.id.bt_work_task_return);
    }
