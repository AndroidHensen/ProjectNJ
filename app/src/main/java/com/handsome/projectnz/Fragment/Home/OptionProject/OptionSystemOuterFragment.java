...
import com.handsome.projectnz.Adapter.Home.OptionProject.OptionSystemOuterAdapter;
...
public class OptionSystemOuterFragment extends BaseLazyFragment {
    private ListView lv_cotent;//容器
    private OptionSystemOuterAdapter adapter;
    @Override
    public int getLayoutId() {
        return R.layout.activity_option_system_outside;
    }
    ...
    public void initData() {
        ...
        adapter=new OptionSystemOuterAdapter(lists,getActivity());
