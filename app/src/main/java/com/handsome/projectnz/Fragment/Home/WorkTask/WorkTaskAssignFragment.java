...
public class WorkTaskAssignFragment extends BaseLazyFragment {
    ...
    private WorkTaskProjectAssignAdapter mAdapter_project;
    private WorkTaskOfficialAssignAdapter mAdapter_official;
    ...
    public void initData() {
        ...
        mAdapter_project = new WorkTaskProjectAssignAdapter(getActivity(), lists_project);
        mAdapter_official = new WorkTaskOfficialAssignAdapter(getActivity(), lists_official);
