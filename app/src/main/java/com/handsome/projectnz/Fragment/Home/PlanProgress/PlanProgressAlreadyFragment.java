...
public class PlanProgressAlreadyFragment extends BaseLazyFragment {
    private ListView lv_content;//列表展示
    private PlanProgressAlreadyAdapter adapter;

    @Override
    public int getLayoutId() {
        return R.layout.activity_plan_progress_already;
    }
    ...
    public void initData() {
       ...
       lists.add(planProgress);
        ...
        adapter=new PlanProgressAlreadyAdapter(lists,getActivity());
