...
public class PlanProgressOverAdapter extends BaseAdapter {
    private List<PlanProgress> lists=new ArrayList<PlanProgress>();
    private Context context;

    public PlanProgressOverAdapter(List<PlanProgress> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        PlanProgressOverAdapter.ViewHolder holder = null;
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.adapter_plan_progress,null,false);
            holder = new PlanProgressOverAdapter.ViewHolder();
            ...
            holder = (PlanProgressOverAdapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.tv_over_time.setText("超期："+lists.get(position).getOver_time()+"天");
        int red = context.getResources().getColor(R.color.red);
        holder.tv_over_time.setTextColor(red);
        return convertView;
    }
