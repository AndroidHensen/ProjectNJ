...
public class
OptionProjectExpanAdapter extends BaseAdapter {
    private List<OptionProject> lists=new ArrayList<OptionProject>();
    private Context context;

    public OptionProjectExpanAdapter(List<OptionProject> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        OptionProjectExpanAdapter.ViewHolder holder = null;
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.view_option_project,null,false);
            holder = new OptionProjectExpanAdapter.ViewHolder();
            ...
            holder = (OptionProjectExpanAdapter.ViewHolder) convertView.getTag();
        }
