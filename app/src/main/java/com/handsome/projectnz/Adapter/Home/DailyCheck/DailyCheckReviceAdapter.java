package com.handsome.projectnz.Adapter.Home.DailyCheck;
...
public class DailyCheckReviceAdapter extends BaseAdapter {
    private List<DailyCheck> lists=new ArrayList<DailyCheck>();
    private Context context;

    public DailyCheckReviceAdapter(List<DailyCheck> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        DailyCheckReviceAdapter.ViewHolder holder = null;
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.adapter_security_check,null,false);
            holder = new DailyCheckReviceAdapter.ViewHolder();
            ...
            holder = (DailyCheckReviceAdapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.tv_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(context, DailyCheckAlreadyActivity.class);
