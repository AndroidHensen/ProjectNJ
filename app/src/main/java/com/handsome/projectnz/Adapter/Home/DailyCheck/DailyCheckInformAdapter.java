...
public class DailyCheckInformAdapter extends BaseAdapter {
    private List<DailyCheck> lists=new ArrayList<DailyCheck>();
    private Context context;

    public DailyCheckInformAdapter(List<DailyCheck> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        DailyCheckInformAdapter.ViewHolder holder = null;
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.adapter_security_check,null,false);
            holder = new DailyCheckInformAdapter.ViewHolder();
            ...
            holder = (DailyCheckInformAdapter.ViewHolder) convertView.getTag();
        }
