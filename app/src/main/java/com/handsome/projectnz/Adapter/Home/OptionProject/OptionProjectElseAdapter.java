...
public class OptionProjectElseAdapter extends BaseAdapter {
    private List<OptionProject> lists=new ArrayList<OptionProject>();
    private Context context;

    public OptionProjectElseAdapter(List<OptionProject> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        OptionProjectElseAdapter.ViewHolder holder = null;
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.view_option_project,null,false);
            holder = new OptionProjectElseAdapter.ViewHolder();
            ...
            holder = (OptionProjectElseAdapter.ViewHolder) convertView.getTag();
        }
