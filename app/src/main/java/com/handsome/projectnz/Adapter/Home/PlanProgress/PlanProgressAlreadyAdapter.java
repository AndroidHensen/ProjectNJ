...
public class PlanProgressAlreadyAdapter extends BaseAdapter {
    private List<PlanProgress> lists=new ArrayList<PlanProgress>();
    private Context context;

    public PlanProgressAlreadyAdapter(List<PlanProgress> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        PlanProgressAlreadyAdapter.ViewHolder holder = null;
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.adapter_plan_progress,null,false);
            holder = new PlanProgressAlreadyAdapter.ViewHolder();
            ...
            holder = (PlanProgressAlreadyAdapter.ViewHolder) convertView.getTag();
        }
        ...
        if (lists.get(position).getTask_kind()=="建造"){
            ...
            holder.tv_task_kind.setTextColor(gray);
        }else{
            ...
            holder.tv_task_kind.setTextColor(red);
        }
