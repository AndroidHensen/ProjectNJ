package com.handsome.projectnz.Adapter.Home.SecurityCheck;
...
import com.handsome.projectnz.View.Home.SecurityCheck.SecurityCheckAlreadyActivity;
...
public class SecurityCheckAdapter extends BaseAdapter {
    ...
    public SecurityCheckAdapter(List<DailyCheck> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder = (SecurityCheckAdapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.tv_detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(context, SecurityCheckAlreadyActivity.class);
