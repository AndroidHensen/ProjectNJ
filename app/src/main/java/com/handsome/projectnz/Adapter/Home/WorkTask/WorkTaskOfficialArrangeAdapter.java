...
public class WorkTaskOfficialArrangeAdapter extends BaseAdapter {
    private List<WorkTaskOfficialMessage> lists = new ArrayList<>();
    private Context context;

    public WorkTaskOfficialArrangeAdapter(Context context, List<WorkTaskOfficialMessage> lists) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        WorkTaskOfficialArrangeAdapter.ViewHolder holder = null;
        if(convertView==null){
            ...
            holder=(WorkTaskOfficialArrangeAdapter.ViewHolder)convertView.getTag();
        }
