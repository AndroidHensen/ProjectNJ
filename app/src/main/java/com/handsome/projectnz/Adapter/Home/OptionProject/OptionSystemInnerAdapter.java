...
public class OptionSystemInnerAdapter extends BaseAdapter {
    private List<OptionProject> lists=new ArrayList<OptionProject>();
    private Context context;

    public OptionSystemInnerAdapter(List<OptionProject> lists, Context context) {
        this.lists = lists;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        OptionSystemInnerAdapter.ViewHolder holder = null;
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.view_option_project,null,false);
            holder = new OptionSystemInnerAdapter.ViewHolder();
            ...
            holder = (OptionSystemInnerAdapter.ViewHolder) convertView.getTag();
        }
